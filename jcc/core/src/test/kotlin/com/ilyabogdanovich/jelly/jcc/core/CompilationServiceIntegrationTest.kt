...
class CompilationServiceIntegrationTest(
    ...
    companion object {
        ...
        fun getTestData(): List<Array<Any>> = listOf(
            ...
            arrayOf("out 1e+6", "1000000", empty()),
            arrayOf("out 1e6", "1000000", empty()),
            arrayOf("out -1e-7", "-1E-7", empty()),
            arrayOf("out -1e+6", "-1000000", empty()),
            arrayOf("out -1e6", "-1000000", empty()),
            arrayOf("out 1.5e6", "1500000", empty()),
            arrayOf("out 1.5e6.5", "1500000", listOf("line 1:9: Unexpected top-level expression: '.5'.")),
            arrayOf("out 0.5e6", "500000", empty()),
            arrayOf("out .5e6", "500000", empty()),
            arrayOf("out 12e2", "1200", empty()),
            arrayOf("out -12e2", "-1200", empty()),
            arrayOf("out 123456e2", "12345600", empty()),
            ...
            arrayOf("out (-1.0)^2.0", "1", empty()),
            arrayOf("out (-1.0)^3.0", "-1", empty()),
            arrayOf("out ((0 + 1) - 23 * 1 / 2 ) * -10 -5", "100", empty()),
            arrayOf("out ((0 + 1) - 23 * 1 / 2 ) * (-10) - 5", "100", empty()),
            arrayOf("out ((0 + 1) - 23 * 1 / 2 ) * (-10) - 55", "50", empty()),
